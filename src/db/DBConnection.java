...
public class DBConnection {
	...
	public JSONArray RecommendRestaurants(String userId) {
		try {
			 ...
			 * (which API, which table?) Step 2, given all these restaurants,
			 * what are the categories (which table?) Step 3, given these
			 * categories, what are the restaurants that belong to them (which
			 * table?) Step 4, filter restaurants that this user has visited.
			 */
